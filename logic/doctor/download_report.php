    ...
    <div style="max-width: 800px; margin: 0 auto;">
        ...
        <header class="report-header">
            ...
            <div class="hospital-info">
                ...
                <?php if (strtotime($report['updated_at']) > strtotime($report['created_at'])): ?>
                    <p style="color:var(--primary); font-size:0.75rem; font-weight:600;">Last Modified: <?php echo date('F d, Y H:i', strtotime($report['updated_at'])); ?></p>
                <?php endif; ?>
            </div>
        </header>
